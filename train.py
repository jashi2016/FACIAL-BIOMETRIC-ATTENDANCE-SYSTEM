...
x2=pkg_resources.resource_filename('cv2', 'data/haarcascade_frontalface_default.xml')
x3=pkg_resources.resource_filename('cv2', 'TrainingImageLabel\Trainner.yml')
    ...
    while True:
        ...
        for(x,y,w,h) in faces:
            ...
            if(conf < 50):
                ...
                aa=df.loc[df['Id'] == Id1]['Name'].values
                print(aa)

                tt=str(Id1)+"-"+aa

                attendance.loc[len(attendance)] = [Id1,aa,date,timeStamp]
